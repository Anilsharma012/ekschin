            ...
            <div>
              ...
              {showDetails && (
                <div className="text-xs mt-1 space-y-1">
                  ...
                  <div className="flex items-center gap-2">
                    <div
                      className={`h-2 w-2 rounded-full ${apiAvailable ? "bg-green-500" : "bg-red-500"}`}
                    />
                    <span>
                  ...
                  <div className="flex items-center gap-2">
                    <div
                      className={`h-2 w-2 rounded-full ${websocketAvailable ? "bg-green-500" : "bg-red-500"}`}
                    />
                    <span>
                      Real-time:{" "}
                      {websocketAvailable ? "Available" : "Unavailable"}
                    </span>
                  </div>
        ...
        {!isFullyAvailable && (
          <div className="mt-3 text-xs">
            ...
            {isOnline && !apiAvailable && (
              <p>
                Server is temporarily unavailable. Using cached data when
                possible.
              </p>
            )}
